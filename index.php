            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">DHIKAES</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      DHARMADHIKA JAYANA - Web Developer
                      <small></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              ?>
              <ul class="treeview-menu">
                <li><a href="index.php?page=data_penjualan_single"><i class="glyphicon glyphicon-education"></i> <span>Data Penjualan Single</span></a></li>
              </ul>
              <ul class="treeview-menu">
                <li><a href="index.php?page=data_penjualan_multi"><i class="glyphicon glyphicon-education"></i> <span>Data Penjualan Multi</span></a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
